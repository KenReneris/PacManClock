...
TimeStr()
{
    ...
    breakTime( g_now, tm );
    tm.Year -= 30;
    return PrintF( F("%02d:%02d:%02d %02d/%02d/%2d"), tm.Hour, tm.Minute, tm.Second, tm.Year, tm.Month, tm.Day );
}
